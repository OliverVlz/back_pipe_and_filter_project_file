...
public class ProcessedFileMetadataDocument {
    ...
    public ProcessedFileMetadataDocument(String fileId, Long fileTableId, String fileName, String mimeType,
            long originalSize, String sha256Original, String sha256Decrypted, boolean decryptValidationOk,
            String encryptionAlgorithm, String ivBase64, String encryptedAesKeyBase64, Instant processedAt) {
        this.fileId = fileId;
    ...
    public String getSha256Decrypted() {
        return sha256Decrypted;
    }

    public void setSha256Decrypted(String sha256Decrypted) {
        this.sha256Decrypted = sha256Decrypted;
    }

    public boolean isDecryptValidationOk() {
        return decryptValidationOk;
    }

    public void setDecryptValidationOk(boolean decryptValidationOk) {
        this.decryptValidationOk = decryptValidationOk;
    }
    ...
    public void setEncryptedAesKeyBase64(String encryptedAesKeyBase64) {
        this.encryptedAesKeyBase64 = encryptedAesKeyBase64;
    }
